...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p><a href="https://medease-server.up.railway.app/auth/email/confirm?email=${email}&token=${magicToken}" style="color: #007bff; word-break: break-all;">http://localhost:8080/confirm-signup?email=${userEmail}&token=${magicToken}</a></p>
