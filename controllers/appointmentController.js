...
export const index = async (req, res, next) => {
  ...
  // Pagination parameters (common for all roles)
  ...
  if (role === "Admin") {
    try {
      // No filter for Admin - fetch all appointments
      ...
      const appointments = await Appointment.find()
        ...
        //.populate("nurseId", "name email") // Uncomment if needed
  ...
  if (role === "Nurse" || role === "Doctor" || role === "Patient") {
    try {
      ...
      // Fetch paginated appointments with sorting and population
